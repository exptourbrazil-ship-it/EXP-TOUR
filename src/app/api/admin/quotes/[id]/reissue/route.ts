...
import { reissueQuote, EmissaoBloqueada } from "@/lib/quote-issue-service";
import { getSupabase, guardCatalog, bad, fail, okData } from "@/lib/catalog-route";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// POST /api/admin/quotes/[id]/reissue — reemite a cotacao ja emitida: recongela
// o cambio, gera NOVO token e arquiva o anterior. Body: validadeDias? (int).
