...
// Ações de aprovação/rejeição do conteúdo de acomodação (Fase B3). Reusa a rota
// admin kind-agnóstica /api/admin/content-submissions.
export default function ConteudoAcomodacaoAprovacaoClient({ id }: { id: string }) {
  ...
  async function agir(acao: "aprovar" | "rejeitar") {
    ...
    try {
      ...
      else router.push("/admin/conteudo-acomodacoes");
    } catch {
