          ...
          <div className="flex max-h-[85vh] w-full max-w-2xl flex-col rounded-2xl bg-white shadow-xl">
            ...
            <div className="border-t border-neutral-200 px-5 py-4">
              ...
              <div className="mt-3 flex justify-end gap-2">
                ...
                <button type="button" onClick={aceitar} disabled={!marcado || enviando} className="rounded-xl bg-cta px-4 py-2 text-sm font-semibold text-brand-cream transition disabled:opacity-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button type="button" onClick={arrepender} disabled={arrependendo} className="rounded-xl bg-brand-golddark px-4 py-2 text-sm font-semibold text-white transition disabled:opacity-50">
