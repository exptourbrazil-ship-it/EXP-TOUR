...
| [`aplicacao-excecoes.md`](./aplicacao-excecoes.md) | Registro de aplicação do módulo de processos de exceção (E1–E11) + Motor de Acerto (Fatia 1): ordem dos patches, DDL, config/crons, verificação, cobertura e pendências. |
